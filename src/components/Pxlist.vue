...
<!-- 클릭하면 월 선택할 수 있는 달력 나오게 -->
	...
	<button id="px-list-option" v-on:click="pxListoption">{{pxlistoption}}</button>
	<v-list id="px-list">
...
export default {
  data() {
    return {
		// keywords: [{name:'판매금액순',nickname:"금액"},{name:'판매수량순',nickname:"수량"}],
		pxlistoption: "판매금액순",
		pxlistopt: "금액",
		pxlistoptnum: 0,
		latestyear: "",
...
// computed: {
// 	chosenpxList: function () {
// 		return this.pxList.filter(function (criteria) {
// 		  return number % 2 === 0
// 		})
// 	 }
// },
